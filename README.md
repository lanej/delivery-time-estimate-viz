...
- Finish at **5 PM** with a single resolved surface: the upper and lower bounds meet the final delivery times, all regional windows read **0 min**, and the uncertainty meshes disappear. **Finish day** advances from the last sample delivery to that endpoint. Rewinding restores the earlier ranges.
